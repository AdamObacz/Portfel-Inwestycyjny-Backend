...
__decorate([
    (0, typeorm_1.ManyToOne)(() => Asset_1.Asset, { onDelete: "CASCADE" }),
    (0, typeorm_1.JoinColumn)({ name: "assetId" }),
    __metadata("design:type", Asset_1.Asset)
], Portfolio.prototype, "asset", void 0);
__decorate([
...
__decorate([
    (0, typeorm_1.Column)({ type: "decimal", precision: 20, scale: 8 }),
    __metadata("design:type", Number)
], Portfolio.prototype, "averagePurchasePrice", void 0);
__decorate([
...
exports.Portfolio = Portfolio = __decorate([
    ...
    (0, typeorm_1.Index)(["userId", "assetId"], { unique: true }) // User can have only one position per asset
], Portfolio);
